...
import com.java.mahongbo.NewsdetailCancelCollectActivity;
...
public class CollectAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new CollectAdapter.ViewHolder_First(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        NewsData newsData = data.get(position);
        CollectAdapter.ViewHolder_First vhfirst = (CollectAdapter.ViewHolder_First) holder;
        ...
        vhfirst.tipview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(mycontext, NewsdetailCancelCollectActivity.class);
